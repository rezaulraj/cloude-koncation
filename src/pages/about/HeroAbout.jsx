    ...
    <section className="py-45 bg-[#F4F4F2] relative" ref={ref}>
      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        >
          ...
          >
            <motion.span
              className="text-[16px] font-sans font-bold text-primary mb-4 block"
            ...
            <motion.h1
              className="text-[48px] text-secondary font-sans leading-tight mb-6"
              variants={textVariants}
            ...
            <motion.p
              className="text-[16px] font-sans text-[#192c33] mt-4 leading-relaxed max-w-2xl"
              variants={textVariants}
